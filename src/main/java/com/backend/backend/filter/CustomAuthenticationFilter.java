...
import com.backend.backend.configs.Credentials;
...
public class CustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    /**
     * url '/login' vem do UsernamePasswordAuthenticationFilter
     * podemos customizar isso no security
     */
...
//        log.info("Roles is: {}", request);
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authentication) throws  IOException {
        ...
        //https://jwt.io/ - pega o token no postman e verifica o que vem no token
        // testa no postman - post - http://localhost:8080/login
